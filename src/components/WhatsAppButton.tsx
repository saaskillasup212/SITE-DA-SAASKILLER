...
const WhatsAppButton = () => {
  ...
  // Link do WhatsApp (substitua o número abaixo pelo número real de suporte)
  const whatsappUrl = "https://wa.me/5511987654321?text=Ol%C3%A1%21%20Preciso%20de%20suporte.";
